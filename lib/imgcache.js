...
var ImgCache = {
  ...
  options: {
    ...
    cordovaIOSBackupFolder: false,          /* enables iCloud backup of the cache folder */
    cordovaAndroidIndexFolder: false,       /* allow Android Gallery indexing of the cache folder */
...
(function ($) {
  ...
  Private.createCacheDir = function (success_callback, error_callback) {
    ...
    var _getDirSuccess = function (dirEntry) {
      ...
      if (Helpers.isCordovaAndroid() && ImgCache.options.cordovaAndroidIndexFolder) {
        ...
        if (Helpers.isCordovaIOS() && !ImgCache.options.cordovaIOSBackupFolder && dirEntry.setMetadata) {
